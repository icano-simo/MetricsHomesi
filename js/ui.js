...
export function renderTable() {
  ...
  if (state.currentMode === 'active') {
    ...
    th.innerHTML = [
      ...
      '<th style="min-width:90px" onclick="srt(String.fromCharCode(112,97))" title="Leads that reached Pre-Approval in window (used in rating)">Leads w/ Pre-Appr &#8597;</th>',
      '<th style="min-width:90px" onclick="srt(String.fromCharCode(114,97,116))" title="Leads that reached Ratified in window (used in rating)">Leads w/ Ratified &#8597;</th>',
      '<th style="min-width:90px" onclick="srt(String.fromCharCode(99,119))" title="Leads closed (Closed Won) in window (used in rating)">Leads Closed Won &#8597;</th>',
      '<th style="min-width:90px;font-style:italic;background:#1a3a5c" onclick="srt(String.fromCharCode(99,117,114,80,97))" title="Opportunities currently in Pre-Approval (exclusive, excludes Closed Lost)">Curr. Pre-Appr &#8597;</th>',
      '<th style="min-width:90px;font-style:italic;background:#1a3a5c" onclick="srt(String.fromCharCode(99,117,114,82,97,116))" title="Opportunities currently in Ratified (exclusive)">Curr. Ratified &#8597;</th>',
      '<th style="min-width:90px;font-style:italic;background:#1a3a5c" onclick="srt(String.fromCharCode(99,117,114,67,119))" title="Opportunities currently in Closed Won (exclusive)">Curr. Closed &#8597;</th>',
      '</tr>',
      '<tr>',
      '<th class="sticky-col sticky-col-0 sticky-shadow" style="' + tL + '">TOTAL</th>',
      '<th class="sticky-col sticky-col-1" style="' + tE + '"></th>',
      '<th class="sticky-col sticky-col-2" style="' + tE + '"></th>',
      '<th class="sticky-col sticky-col-3 sticky-shadow" style="' + tE + '"></th>',
