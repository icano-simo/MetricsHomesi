...
export function renderLoTable() {
  ...
  if (state.loCurrentMode === 'active') {
    ...
    th.innerHTML = [
      ...
      '<th style="min-width:90px" onclick="srtLo(\'pa\')" title="Leads that reached Pre-Approval in window">Leads w/ Pre-Appr &#8597;</th>',
      '<th style="min-width:90px" onclick="srtLo(\'rat\')" title="Leads that reached Ratified in window">Leads w/ Ratified &#8597;</th>',
      '<th style="min-width:90px" onclick="srtLo(\'cw\')" title="Leads closed (Closed Won) in window">Leads Closed Won &#8597;</th>',
      '<th style="min-width:90px;font-style:italic;background:#1a3a5c" onclick="srtLo(\'curPa\')" title="Opportunities currently in Pre-Approval">Curr. Pre-Appr &#8597;</th>',
      '<th style="min-width:90px;font-style:italic;background:#1a3a5c" onclick="srtLo(\'curRat\')" title="Opportunities currently in Ratified">Curr. Ratified &#8597;</th>',
      '<th style="min-width:90px;font-style:italic;background:#1a3a5c" onclick="srtLo(\'curCw\')" title="Opportunities currently in Closed Won">Curr. Closed &#8597;</th>',
      '</tr>',
      '<tr>',
